...
const char* TCoapTransport::CRLF = "\r\n";
const int TCoapTransport::CRLF_LEN = 2;
...
uint32_t TCoapTransport::readMoreData() {
  uint32_t size;
...
uint32_t TCoapTransport::readChunked() {
  uint32_t length = 0;
...
void TCoapTransport::readChunkedFooters() {
...
uint32_t TCoapTransport::parseChunkSize(char* line) {
...
uint32_t TCoapTransport::readContent(uint32_t size) {
  uint32_t need = size;
  while (need > 0) {
...
void TCoapTransport::readHeaders() {
