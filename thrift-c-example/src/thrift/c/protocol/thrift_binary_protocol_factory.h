...
#ifndef THRIFT_BINARY_PROTOCOL_FACTORY_H_
#define THRIFT_BINARY_PROTOCOL_FACTORY_H_

#include <sys/cdefs.h>

#include <thrift/c/protocol/thrift_protocol_factory.h>
...
struct _ThriftBinaryProtocolFactory {
  ...
  ThriftProtocolFactory thrift_protocol_factory_interface;
};
...
#endif /* THRIFT_BINARY_PROTOCOL_FACTORY_H_ */
