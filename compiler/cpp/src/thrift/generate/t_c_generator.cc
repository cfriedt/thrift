...
public:
  ...
  t_c_generator(t_program* program,
    ...
    for( iter = parsed_options.begin(); iter != parsed_options.end(); ++iter) {
      throw "unknown option c:" + iter->first;
    }
...
void t_c_generator::init_generator() {
  ...
  f_types_ << "/* base includes */" << endl << "#include <glib-object.h>" << endl
           << "#include <thrift/c/thrift_struct.h>" << endl
           << "#include <thrift/c/protocol/thrift_protocol.h>" << endl;
  ...
  if (!includes.empty()) {
    ...
    for (auto include : includes) {
      const std::string& include_nspace = include->get_namespace("c");
  ...
  f_types_impl_ << endl << "#include \"" << this->nspace_lc << program_name_u << "_types.h\""
                << endl << "#include <thrift/c/thrift.h>" << endl << endl;
...
void t_c_generator::generate_service(t_service* tservice) {
  ...
  f_header_ << "#include <thrift/c/processor/thrift_dispatch_processor.h>" << endl << endl;
  ...
  // include the headers
  f_service_ << "#include <string.h>" << endl << "#include <thrift/c/thrift.h>" << endl
             << "#include <thrift/c/thrift_application_exception.h>" << endl << "#include \""
...
bool t_c_generator::is_numeric(t_type* ttype) {
...
string t_c_generator::type_name(t_type* ttype, bool in_typedef, bool is_const) {
  ...
  string pname = (tprogram ? tprogram->get_namespace("c") : "") + ttype->get_name();
 ...
 */
string t_c_generator::property_type_name(t_type* ttype, bool in_typedef, bool is_const) {
  string result;
 ...
 */
string t_c_generator::base_type_name(t_type* type) {
  if (type->is_enum()) {
 ...
 */
string t_c_generator::constant_literal(t_type* type, t_const_value* value) {
...
string t_c_generator::constant_value_with_storage(string fname,
                                                       t_type* etype,
                                                       t_const_value* value) {
  ostringstream render;
  if (is_numeric(etype)) {
 ...
 */
void t_c_generator::generate_service_helpers(t_service* tservice) {
 ...
 */
void t_c_generator::generate_service_handler(t_service* tservice) {
  vector<t_function*> functions = tservice->get_functions();
 ...
 */
void t_c_generator::generate_service_processor(t_service* tservice) {
  vector<t_function*> functions = tservice->get_functions();
  vector<t_function*>::const_iterator function_iter;
...
void t_c_generator::generate_object(t_struct* tstruct) {
  ...
  for (m_iter = members.begin(); m_iter != members.end(); ++m_iter) {
    ...
    if (t->is_base_type()) {
      ...
      string type_nspace = type_program ? type_program->get_namespace("c") : "";
 ...
 */
void t_c_generator::generate_struct_writer(ostream& out,
                                                t_struct* tstruct,
                                                string this_name,
                                                string this_get,
                                                bool is_function) {
 ...
 */
void t_c_generator::generate_struct_reader(ostream& out,
                                                t_struct* tstruct,
                                                string this_name,
                                                string this_get,
                                                bool is_function) {
...
void t_c_generator::generate_serialize_field(ostream& out,
                                                  t_field* tfield,
                                                  string prefix,
                                                  string suffix,
                                                  int error_ret) {
...
void t_c_generator::generate_serialize_struct(ostream& out,
                                                   t_struct* tstruct,
                                                   string prefix,
                                                   int error_ret) {
  (void)tstruct;
...
void t_c_generator::generate_serialize_container(ostream& out,
                                                      t_type* ttype,
                                                      string prefix,
                                                      int error_ret) {
  scope_up(out);
...
void t_c_generator::generate_serialize_map_element(ostream& out,
                                                        t_map* tmap,
                                                        string key,
                                                        string value,
                                                        int error_ret) {
...
void t_c_generator::generate_serialize_set_element(ostream& out,
                                                        t_set* tset,
                                                        string element,
                                                        int error_ret) {
...
void t_c_generator::generate_serialize_list_element(ostream& out,
                                                         t_list* tlist,
                                                         string list,
                                                         string index,
                                                         int error_ret) {
...
void t_c_generator::generate_deserialize_field(ostream& out,
                                                    t_field* tfield,
                                                    string prefix,
                                                    string suffix,
                                                    int error_ret,
...
void t_c_generator::generate_deserialize_struct(ostream& out,
                                                     t_struct* tstruct,
                                                     string prefix,
                                                     int error_ret,
                                                     bool allocate) {
...
void t_c_generator::generate_deserialize_container(ostream& out,
                                                        t_type* ttype,
                                                        string prefix,
                                                        int error_ret) {
  scope_up(out);
...
void t_c_generator::declare_local_variable(ostream& out, t_type* ttype, string& name, bool for_hash_table) {
...
void t_c_generator::declore_local_variable_for_write(ostream& out,
                                                          t_type* ttype,
                                                          string& name) {
  string tname = type_name(ttype);
  ttype = get_true_type(ttype);
...
void t_c_generator::generate_deserialize_map_element(ostream& out,
                                                          t_map* tmap,
                                                          string prefix,
                                                          int error_ret) {
...
void t_c_generator::generate_deserialize_set_element(ostream& out,
                                                          t_set* tset,
                                                          string prefix,
                                                          int error_ret) {
...
void t_c_generator::generate_deserialize_list_element(ostream& out,
                                                           t_list* tlist,
                                                           string prefix,
                                                           string index,
                                                           int error_ret) {
...
string t_c_generator::generate_free_func_from_type(t_type* ttype) {
  if (ttype == NULL)
    return "NULL";
...
string t_c_generator::generate_hash_func_from_type(t_type* ttype) {
  if (ttype == NULL)
    return "NULL";
...
string t_c_generator::generate_cmp_func_from_type(t_type* ttype) {
  if (ttype == NULL)
    return "NULL";
...
string t_c_generator::generate_new_hash_from_type(t_type* key, t_type* value) {
...
THRIFT_REGISTER_GENERATOR(c, "C, using GLib", "")
